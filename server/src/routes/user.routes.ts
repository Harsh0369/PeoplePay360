...
import { getJoinRequestsController, updateUserRoleController, getUsersController } from "../controllers/user.controller";
...
router.get("/", requireAnyPermission("admin", "Settings.Write"), getUsersController);
