...
import { clockInService, clockOutService } from "../../services/attendance.service";
import { ResponseUtil } from "../../utils/response.util";
import { catchAsync } from "../../utils/catch-async.util";
import { User } from "../../models/user.model";
import { NotFoundError, ForbiddenError } from "../../errors/index";

// Helper to get employeeId from AuthRequest
const getEmployeeId = async (req: AuthRequest) => {
