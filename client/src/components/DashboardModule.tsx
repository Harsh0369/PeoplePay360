...
export const DashboardModule: React.FC = () => {
  ...
  return (
    <div className="flex-1 overflow-y-auto no-scrollbar bg-canvas px-4 sm:px-6 lg:px-8 py-6">
      {activeReport && (
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 tracking-tight">Dashboard & Analytics</h1>
          ...
          <div onClick={() => handleCardClick('Headcount')} className="cursor-pointer bg-white border border-slate-200/90 rounded-2xl p-5 hover:border-brand-100 transition-all group overflow-hidden relative shadow-card hover:shadow-card-hover">
            <div className="flex items-start justify-between relative z-10">
              <div>
                ...
                <h3 className="text-2xl sm:text-4xl font-bold text-slate-900 mt-2">{stats?.headcount || 0}</h3>
              </div>
          ...
          <div className="bg-white border border-slate-200/90 rounded-2xl p-5 transition-all group overflow-hidden relative shadow-card hover:shadow-card-hover">
            <div className="flex items-start justify-between relative z-10">
              <div>
                ...
                <h3 className="text-2xl sm:text-4xl font-bold text-slate-900 mt-2">{stats?.todaysAttendance || 0}</h3>
              </div>
          ...
          <div className="bg-white border border-slate-200/90 rounded-2xl p-5 transition-all group overflow-hidden relative shadow-card hover:shadow-card-hover">
            <div className="flex items-start justify-between relative z-10">
              <div>
                ...
                <h3 className="text-2xl sm:text-4xl font-bold text-slate-900 mt-2">{stats?.pendingTimeOffs || 0}</h3>
              </div>
