                ...
                >
                  <td className="py-3 px-5 flex items-center space-x-3">
                    <img
                      ...
                      alt={emp.name}
                      className="w-9 h-9 rounded-full object-cover border border-brand-sandBorder flex-shrink-0"
                    />
                    <div>
                  ...
                  <td className="py-3 px-4">
                    <span className="font-semibold bg-brand-softSand text-brand-deepTeal border border-brand-sandBorder px-2.5 py-0.5 rounded text-[11px] inline-block">
                      {emp.department}
                    </span>
                  </td>
